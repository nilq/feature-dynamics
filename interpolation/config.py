...
class InterpolationConfig(BaseModel):
    ...
    dataset_a: DatasetConfig = Field(
        ..., description="Dataset configuration for evaluation of model A."
    )
    dataset_b: DatasetConfig = Field(
        ..., description="Dataset configuration for evaluation of model B."
    )
